...
(88, 'KOHLER Caxton Vitreous China 15.69-in Undermount Rectangular Transitional White Bathroom Sink', 'Bathroom', 3, 139.00),
(52, 'Moen Align Chrome Single-Handle Faucet', 'Bathroom', 3, 129.00),
(89, 'Vaneri 4 in. Centerset Double Handle High Arc Bathroom Faucet in Matte Black', 'Bathroom', 2, 74.99),
(53, 'Delta Linden 24-in Towel Bar, Brushed Nickel', 'Bathroom', 4, 34.99),
(91, 'Delta 759240-BL Trinsic 24 in. Wall Mount Towel Bar Bath Hardware Accessory in Matte Black', 'Bathroom', 5, 61.97),
(54, 'American Standard Cadet 3 Toilet, White', 'Bathroom', 2, 189.00),
(90, 'American Standard Cadet 3 FloWise ADA Compliant 1.28 gal White Elongated Complete Toilet', 'Bathroom', 4, 219.99),
(55, 'Aquabrass Rainfall Shower Head, Polished Chrome', 'Bathroom', 5, 149.00),
(87, 'Chrome Plated Round Showerhead · 5 Function · 1.75gpm', 'Bathroom', 1, 21.88),
(56, 'InterDesign York Metal Wastebasket, Chrome', 'Bathroom', 5, 22.50),
(92, '2.6 Gal. Stainless Steel Slim Step-On Trash Can', 'Bathroom', 2, 34.97),
-- Kitchen
(57, 'Samsung 30-in Gas Cooktop, Stainless Steel', 'Kitchen', 3, 599.00),
(93, '800 Series 36 in. 3.7 cu ft. 5 Burner Slide-In Industrial Style Induction Range w/ Convection Pro in Stainless Steel', 'Kitchen', 2, 6799.00),
(58, 'Whirlpool 18 cu. ft. Top-Freezer Refrigerator, White', 'Kitchen', 2, 799.00),
(94, 'LG Standard-Depth Craft Ice 27.8-cu ft 4 -Door 36-in Wide Smart Compatible French Door Refrigerator with Dual Ice Maker with Water and Ice Dispenser ( PrintProof Stainless Steel ) ENERGY STAR Certified', 'Kitchen', 3, 3699.00),
(59, 'GE 24-in Built-In Dishwasher, Stainless Steel', 'Kitchen', 3, 549.00),
(95, '24 in. Fingerprint Resistant Stainless Front Control Built-In Tall Tub 50 dBA Dishwasher with Dual Power Filtration', 'Kitchen', 2, 879.00),
(60, 'Kohler Villager Undermount Kitchen Sink, Stainless Steel', 'Kitchen', 2, 269.00),
(96, 'Franke Tectonite Dual Mount 33 in. W X 22 in. L Double Bowl Kitchen Sink Black', 'Kitchen', 4, 279.99),
(61, 'Moen Arbor Chrome Pull-Down Kitchen Faucet', 'Kitchen', 4, 199.00),
(97, 'Bolden Single Handle 18-Inch Commercial Kitchen Faucet with Dual Function Pull Down Sprayhead in Stainless Steel', 'Kitchen', 2, 199.95),
(62, 'KitchenAid 5-Quart Stand Mixer, Empire Red', 'Kitchen', 5, 399.00),
(98, 'Ninja Professional XL 72-oz 4-Speed Countertop Blender (Black/Silver)', 'Kitchen', 3, 109.99),
-- Outdoors
(63, 'Weber Spirit II E-310 Gas Grill, Black', 'Outdoors', 3, 599.00),
(99, 'Blackstone 2 Burner Liquid Propane Outdoor Griddle Black', 'Outdoors', 4, 299.99),
(100, 'GCI Outdoor Freestyle Cinnamon Freestyle Folding Rocker', 'Outdoors', 4, 94.99),
